...
export class Backend implements backendInterface {
    ...
    async getPersonalBest(arg0: string): Promise<bigint | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPersonalBest(arg0);
    ...
    async submitScore(arg0: string, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
